"""Load continuous PPO and swing Pendulum with human render."""
...
def select_action(model: ActorCritic, state: np.ndarray) -> np.ndarray:
    """Deterministic: use policy mean (no exploration noise)."""
    with torch.no_grad():
