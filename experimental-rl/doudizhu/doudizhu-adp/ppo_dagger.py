"""DAgger from frozen DouZero-ADP on PPO states. Saves ppo_adp_dagger.pth."""
...
from clone import clone_update_seat
...
SAVE_BEST = "ppo_adp_dagger.pth"
SAVE_CURVE = "reward_history_dagger.png"
EVAL_DATA = RULER / "eval_data.pkl"
DEFAULT_INIT = HERE / "ppo_adp_scale.pth"
...
def main() -> None:
    ...
    for update in range(1, args.max_updates + 1):
        batch = collect_dagger_games(env, models, dz, args.min_games)
        losses = [
    ...
    if wp_history:
        ...
        plt.title("DAgger: student walk, DouZero labels")
        plt.tight_layout()
