...
DAgger：`ppo_dagger.py` 从 `ppo_adp_scale.pth` 起步，PPO 出牌、冻结 DouZero 在当前状态标动作，存 `ppo_adp_dagger.pth`。
...
python eval_vs.py --side_a ppo --ppo ppo_adp_dagger.pth --side_b ../DouZero/baselines/douzero_ADP --max_deals 200
```
